          ...
          <div className="hidden md:flex items-center gap-6 lg:gap-8">
            ...
            {user?.role === "employer" && (
              <>
                ...
                <Link to="/my-posted-jobs" className="text-white hover:text-amber-400 transition-colors duration-200 font-medium">
            ...
            {user?.role === "seeker" && (
              <Link to="/my-applications" className="text-white hover:text-amber-400 transition-colors duration-200 font-medium">
            ...
            {!user ? (
              ...
              <div className="flex items-center gap-3 lg:gap-4">
                <button onClick={logout} className="px-3 lg:px-4 py-2 border border-white text-white rounded-lg hover:bg-white hover:text-blue-900 transition-all duration-200 font-medium text-sm">
                  Logout
                </button>
              ...
              {user ? (
                <>
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 border border-white text-white rounded-lg hover:bg-white hover:text-blue-900 transition-all duration-200 font-medium text-xs"
                  >
                    Logout
                  </button>
                </>
